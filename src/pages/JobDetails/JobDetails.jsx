...
const JobDetails = () => {
    const {title,description,company,company_logo,jobType,salaryRange,requirements,location,applicationDeadline,hr_name,hr_email,responsibilities,status} = useLoaderData();
